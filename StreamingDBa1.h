...
private:
	AVLTree<User> *users;
	AVLTree<Movie> *comedie;
	AVLTree<Movie> *drama;
	AVLTree<Movie> *action;
	AVLTree<Movie> *fantasy;
	//AVLTree<AVLTree<Movie>> *movies; // a tree of roots to different movie trees;
	AVLTree<GroupTree> *groups; // a tree of roots to different group trees;
